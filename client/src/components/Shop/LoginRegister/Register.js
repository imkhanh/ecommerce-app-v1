...
const initialState = { fullname: '', username: '', email: '', password: '', error: null, success: null };
	...
	return (
		<div className="px-12 pb-8">
			<form onSubmit={handleSubmit} className="space-y-3">
				<div>
					<label className="block mb-1 text-sm text-black/80">Full name</label>
					<input
						type="text"
						name="fullname"
				...
				<div>
					<label className="block mb-1 text-sm text-black/80">User name</label>
					<input
						type="text"
						name="username"
