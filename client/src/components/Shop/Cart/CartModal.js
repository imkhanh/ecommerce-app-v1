...
const CartModal = () => {
	...
	return (
		<div>
			...
			<div className={`${data.cartModal ? 'translate-x-0 opacity-100' : 'translate-x-full opacity-0'} fixed top-0 right-0 max-w-[400px] w-full transform h-screen bg-white transition-all duration-300 ease-in-out shadow-lg z-50`}>
